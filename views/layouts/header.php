            ...
            <header id="header">
                ...
                <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <?php if (User::isGuest()): ?>                                        
                            <li class="nav-item"><a href="/user/login/" class='nav-link nav__link--last'><i class="login"></i> Вход</a></li>
                        <?php else: ?>
                            <li class="nav-item"><a href="/cabinet/" class='nav-link'><i class="user"></i><?php echo $name; echo $user['name'];?></a></li>
                            <li class="nav-item"><a href="/user/logout/" class='nav-link nav__link--last'><i class="logOut"></i> Выход</a></li>
                        <?php endif; ?>
                    </ul>
                    </div>
                </nav>
