    ...
    <header id="header">
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark custom__navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link--category-btn " href="#categoryList" data-toggle="collapse" role="button"
      ...
      <!-- <div class="header__wrapper">
                    ...
                    <ul class='nav'>
                        ...
                        <?php else : ?>
                            <li><a href="/cabinet/" class='nav__link'><i class="user"></i><?php echo $name;
                                                                                            echo $user['name']; ?></a></li>
